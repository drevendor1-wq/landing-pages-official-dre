    ...
    try {
      const response = await fetch("/api/submit-enquiry", {
        ...
        body: JSON.stringify({
          ...
          message: `Enquiry For: Tierra Viva Marbella | DarGlobal`,
  ...
  return (
    <section id="Contact" className="relative bg-sky-50 pb-32">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://lh3.googleusercontent.com/sitesv/APaQ0SSgME4zSUetul0myb-p9TrGQvGWUrzDAeGZ4FMiSCAMlYy0GA-eUTJGwGYggbHMoJV41qStD_8-_E1ooOQQY5O_Rw_nY9FOteXi-yoNhb4ASVe5nD8gMhG5Emk6csUDe6DuNUjQja_PSLoIAfWGVlfoJvQXJUnZGHh1e_t6NQ9P0_o1HLPr7GLM=w16383')"
        }}
      >
        {/* Dark overlay */}
