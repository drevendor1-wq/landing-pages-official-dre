            ...
            >
              <div className="relative w-full bg-white rounded-t-[2.5rem] shadow-2xl p-8 pb-12 overflow-hidden border-t border-emerald-50">
                ...
                <div className="mt-4 mb-8">
                  <span className="text-[#D4AF37] font-bold tracking-[0.3em] uppercase text-[10px] mb-2 block">
                    Exclusive Access
                  </span>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full mt-4 text-white py-5 rounded-xl font-bold text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-emerald-900 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-3"
                  >
