...
const About: React.FC = () => {
  return (
    <section className="py-24 bg-[#1a1a1a] text-white overflow-hidden relative">
      <div className="max-w-9xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="mt-12 flex flex-col lg:flex-row border border-white/10 rounded-2xl overflow-hidden bg-white/[0.03]">
  {[
    ...
    <div 
      key={idx} 
      className={`p-4 xl:p-8 flex-1 flex flex-col justify-center ${
        idx !== 3 ? 'border-b lg:border-b-0 lg:border-r border-white/10' : ''
      }`}
    >
      <p className="text-[9px] tracking-[0.1em] font-bold uppercase text-gray-500 mb-2 whitespace-nowrap">
        {item.label}
      </p>
      <p className="text-base xl:text-xl font-medium text-white whitespace-nowrap">
        {item.value}
      </p>
    </div>
  ))}
