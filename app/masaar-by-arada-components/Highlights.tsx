...
const FloorPlan = () => {
  ...
  const plans = {
    'Townhouses': { 
      price: '4.2M', 
      description: 'A tranquil and roomy home with a garden, balcony, covered parking, living and dining area, lobby, laundry room, understairs storage room, guest bathroom, maid\'s bedroom and bathroom, and ensuite master bedroom and dressing room.',
      features: ['Master suite with ensuite', 'Guest bathroom', 'Large terraces', 'Maid\'s room available'],
      image: 'https://masaar.salescenter.click/assets/5B-SVB-zUd359qp.jpg' 
    },
    'Villas': { 
      price: '6.8M', 
      description: 'A spacious and sophisticated home with a garden, swimming pool, balcony, covered parking, living and dining area, majlis, family room, laundry room, guest bathroom, maid\'s bedroom and bathroom, and ensuite master bedroom and dressing room.',
      features: ['Floor-to-ceiling windows', 'Private garages', 'Expansive terraces', 'Premium finishes'],
      image: 'https://masaar.salescenter.click/assets/5B-FSVA-T6KhykSf.jpg' 
    },
  };
  ...
  <div className="sticky top-24">
    {/* Section Tag */}
    <span className="text-[8px] md:text-[9px] font-medium tracking-[0.5em] text-[#047857] uppercase mb-4 md:mb-8 block">
  ...
  className="w-full text-white bg-green-700 py-2 md:py-3 rounded-full text-[4px] md:text-[8px] font-bold tracking-[0.1em] uppercase flex items-center justify-center gap-3 md:gap-4"
>
