...
const PaymentPlan = () => {
  ...
  return (
    <section id="payment-plan" className="py-24 px-6 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <motion.span 
            ...
            viewport={{ once: true }}
            className="text-[#047857] font-bold tracking-[0.2em] uppercase text-[10px] mb-4 block"
          >
          ...
          >
            Flexible <span className="italic text-[#047857]">Payment Plan</span>
          </motion.h2>
      ...
      <ContactModal isOpen={enquiryModalOpen} onClose={closeEnquiryModal} floorPlanTitle="Masaar By Arada at Sharjah" buttonText={buttonText} />
    </section>
  );
};
