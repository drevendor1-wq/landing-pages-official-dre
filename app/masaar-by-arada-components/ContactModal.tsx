...
export default function ContactModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-[840px] max-h-[90vh] overflow-y-auto md:overflow-hidden bg-white border border-emerald-100 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.1)] rounded-sm flex flex-col md:grid md:grid-cols-2"
        onClick={(e) => e.stopPropagation()}
        ref={cardRef}
      >
        ...
        <div
          className="relative h-[180px] md:h-auto md:order-2 bg-cover bg-center"
          style={{ backgroundImage: `url('https://www.cbnme.com/wp-content/uploads/2024/06/Rear-view-of-Four-Bedroom-Villa-in-the-Saro-district-of-Masaar.jpg')` }}
        >
