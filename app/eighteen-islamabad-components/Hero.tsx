...
const Hero = () => {
  ...
  return (
    <>
        ...
        <div className="relative z-10 w-full grid grid-cols-1 md:grid-cols-12 gap-10 items-end">
          <div className="md:col-span-8">
            ...
            >
              ...
              <span className="block text-3xl md:text-[12rem] font-bold leading-none -ml-1 md:-ml-2">EIGHTEEN ISLAMABAD</span>
            </motion.h1>
          </div>
      ...
      <ContactModal isOpen={enquiryModalOpen} onClose={() => setEnquiryModalOpen(false)} floorPlanTitle="Enquiry For: EIGHTEEN ISLAMABAD" buttonText={buttonText} />
    </>
  );
};
