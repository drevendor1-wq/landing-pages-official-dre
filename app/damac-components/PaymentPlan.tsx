  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-20 items-center">
        <div>
          <h2 className="text-4xl md:text-5xl font-heading font-light text-zinc-900 mb-8">
        ...
        <div className="space-y-6">
          {milestones.map((m, idx) => (
            <div key={idx} className="flex items-center gap-8 p-8 rounded-3xl bg-white border border-zinc-100 hover:shadow-lg transition-all group">
               ...
               <div>
                  <h4 className="text-xl font-medium mb-1 group-hover:text-zinc-600">{m.label}</h4>
               </div>
            </div>
          ))}
        </div>
