        ...
        <div className="container">
          <div className="properties-grid">
            ...
            <div className="property-card">
              ...
              <div className="property-image-wrapper">
                <Image
                  src="/images/nakheel-palm-central/MasaarCover.jpg"
                  alt="Damac Islands 2"
                  width={800}
                  height={500}
                  style={{ width: "100%", height: "350px", objectFit: "cover" }}
              ...
              <div className="property-details">
                <h2 className="property-name">MASAAR BY ARADA</h2>
                ...
                <div className="property-actions">
                  ...
                  <Link href="/masaar-by-arada" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
          ...
          {/* MARASSI NORTH COAST - EGYPT  */}
            ...
            {/* <div className="property-card">
              ...
              <div className="property-details">
                ...
                <div className="property-actions">
                  ...
                  <Link href="/tower-nine-elms" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
            ...
            <div className="property-card">
              ...
              <div className="property-details">
                <h2 className="property-name">EAGLE HILLS TBILISI WATERFRONT</h2>
                ...
                <div className="property-actions">
                  ...
                  <Link href="/eagle-hills-tbilisi-waterfront" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
            ...
            <div className="property-card">
              ...
              <div className="property-image-wrapper">
                <Image
                  src="/images/nakheel-palm-central/cairoGateCover.jpg"
                  alt="Palm Central at Dubai"
                  width={800}
                  height={500}
                  style={{ width: "100%", height: "350px", objectFit: "cover" }}
              ...
              {/* SOBHA Property Details */}
              <div className="property-details">
                <h2 className="property-name">EMAAR CAIRO GATE</h2>
                ...
                <div className="property-actions">
                  ...
                  <Link href="/cairo-gate-emaar" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
          ...
          <div className="property-card">
              ...
              {/* SOBHA Property Details */}
              <div className="property-details">
                <h2 className="property-name">TIERRA VIVA MARBELLA</h2>
                ...
                <div className="property-actions">
                  ...
                  <Link href="/tierra-viva-marbella" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
            ...
            <div className="property-card">
              ...
              <div className="property-image-wrapper">
                <Image
                  src="/images/nakheel-palm-central/rigaCover.jpg"
                  alt="TIERRA VIVA MARBELLA"
                  width={800}
                  height={500}
                  style={{ width: "100%", height: "350px", objectFit: "cover" }}
              ...
              {/* SOBHA Property Details */}
              <div className="property-details">
                <h2 className="property-name">EAGLE HILLS RIGA WATERFRONT</h2>
                ...
                <div className="property-actions">
                  ...
                  <Link href="/eagle-hills-riga-waterfront" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
            ...
            <div className="property-card">
              ...
              {/* SOBHA Property Details */}
              <div className="property-details">
                <h2 className="property-name">ZED Sheikh Zayed</h2>
                ...
                <div className="property-actions">
                  ...
                  <Link href="/zed-sheikh-zayed" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
           ...
           {/* EIGHTEEN ISLAMABAD*/}
            <div className="property-card">
              ...
              <div className="property-image-wrapper">
                <Image
                  src="/images/nakheel-palm-central/eighteenCover.jpg"
                  alt="TIERRA VIVA MARBELLA"
                  width={800}
                  height={500}
                  style={{ width: "100%", height: "350px", objectFit: "cover" }}
              ...
              {/* SOBHA Property Details */}
              <div className="property-details">
                <h2 className="property-name">Eighteen Islamabad</h2>
                ...
                <div className="property-actions">
                  ...
                  <Link href="/eighteen-islamabad" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
            ...
            <div className="property-card">
              ...
              {/* SOBHA Property Details */}
              <div className="property-details">
                <h2 className="property-name">AYIA NAPA MARINA</h2>
                ...
                <div className="property-actions">
                  ...
                  <Link href="/ayia-napa-marina" className="property-action-btn">
                    View Details
                  </Link>
                </div>
              </div>
