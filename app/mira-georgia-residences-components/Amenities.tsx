...
const Amenities = () => {
  const amenityCards = [
    ...
    },
    {
      ...
      image: "https://mira-verde.com/assets/031.webp",
    },
    {
      title: "AI University",
              ...
              <SwiperSlide key={i}>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 p-8 w-full">
                    <h3 className="text-white text-2xl font-serif mb-3">{item.title}</h3>
                    {item.description && (
                      <p className="text-white text-sm font-light leading-relaxed max-w-[250px]">
                        {item.description}
                      </p>
                    )}
                  </div>
