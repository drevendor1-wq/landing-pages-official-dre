...
const NakheelFixedMobileButton = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 md:hidden p-1 bg-[#047857] backdrop-blur-lg border-t border-emerald-100 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
        <button
          onClick={togglePopup}
          ...
          <>
            ...
            >
              <div className="relative w-full bg-white rounded-t-[2.5rem] shadow-2xl p-8 pb-12 overflow-hidden border-t border-emerald-50">
                ...
                {/* Visual Accent */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-1.5 bg-[#047857] rounded-full mt-3 opacity-50"></div>
                ...
                <div className="mt-4 mb-8">
                  <span className="text-[#047857] font-bold tracking-[0.3em] uppercase text-[10px] mb-2 block">
                    Exclusive Access
                  </span>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-start gap-3 text-[11px] text-zinc-500 leading-tight py-2">
                    <input
                      ...
                      required
                      className="mt-0.5 accent-emerald-800 h-4 w-4"
                    />
                    <p>
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full mt-4 bg-green-700 text-white py-5 rounded-xl font-bold text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-emerald-900 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-3"
                  >
