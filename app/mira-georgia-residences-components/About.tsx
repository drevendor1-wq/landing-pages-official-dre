...
const About = () => {
  const features = [
    ...
    {
      title: "Nature & Escape",
      image: "https://mira-verde.com/assets/0aff27cddd2acf5a760baae86fed9165c9823ea7.webp", // Placeholder for Nature/Mountains
      description: "Among forested ridges and open elevations, residents enjoy access to Shavnabada Monastery, the trails of Tbilisi National Park, and Lisi Lake. Walking and cycling routes, space to recharge, without leaving the city."
    },
    {
      title: "The City Within Reach",
      image: "https://mira-verde.com/assets/3f1d3ab98f50e46ac91fa83cbf9b641e63128061.webp", // Placeholder for City/Urban
      description: "Within 10–15 minutes—fine dining, boutique retail, and cultural institutions in the heart of Tbilisi. Mira Verde combines the privacy of a hillside setting with daily access to everything the capital has to offer."
    }
  ];
