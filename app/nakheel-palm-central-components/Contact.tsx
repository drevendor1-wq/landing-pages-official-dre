...
export default function ContactFloating() {
    ...
    try {
      const response = await fetch("/api/submit-enquiry", {
        ...
        body: JSON.stringify({
          ...
          message: `Enquiry for: Nakheel Palm Central`,
  ...
  return (
    <section id="Contact" className="relative bg-sky-50 pb-32">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://www.nakheel.com/images/nakheelcorporatelibraries/amenities/palm-jumeirah_1.jpg?sfvrsn=7b46249c_1')"
        }}
      >
        {/* Dark overlay */}
  ...
  <h1 className="text-5xl md:text-6xl font-serif italic font-light mb-4 tracking-tight">
    Palm Central
  </h1>

  <p className="uppercase tracking-[0.2em] text-[10px] md:text-xs font-light opacity-80">
    Relaxed. Communal. Wellness Oriented.
  </p>
</div>
      </div>
