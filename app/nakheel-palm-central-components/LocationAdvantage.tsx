...
const LocationAdvantage = () => {
  const travelTimes = [
    { time: "10 min", label: "JBR Beach", icon: <Landmark size={18} /> },
    { time: "15 min", label: "Dubai Marina", icon: <ShoppingBag size={18} /> },
    { time: "20 min", label: "Dubai International Airport", icon: <Plane size={18} /> },
    { time: "25 min", label: "Downtown Dubai", icon: <Car size={18} /> },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-0 rounded-[32px] md:rounded-[40px] overflow-hidden bg-white shadow-2xl shadow-blue-900/5 border border-white">
          ...
          <div className="lg:w-[60%] relative h-[350px] md:h-[500px] lg:h-auto overflow-hidden group order-1 lg:order-2">
            <motion.img 
              ...
              src="https://manage.tanamiproperties.com/Project/Location_Map/2882/Thumb/2882.webp" 
              alt="Map View" 
