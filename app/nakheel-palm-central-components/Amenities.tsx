...
const Amenities = () => {
  const amenities = [
    { title: "Private Boat Rides", icon: <Ship size={20} /> },
    { title: "Gymnasium & Fitness", icon: <Dumbbell size={20} /> },
    { title: "Yoga & Sun Decks", icon: <Sun size={20} /> },
    { title: "Paddling", icon: <Anchor size={20} /> },
    { title: "Swimming Pools", icon: <Waves size={20} /> },
    { title: "Mini Golf Island", icon: <Flag size={20} /> },
    { title: "Wedding Venue", icon: <Circle size={20} /> },
    { title: "Jungle River", icon: <Mountain size={20} /> },
    { title: "Lagoon Tour in Hammock", icon: <Tent size={20} /> },
  ];
