...
export const metadata: Metadata = {
  title: "Marea Residences by Sharafi | Luxury Beachfront Homes on Dubai Islands",
  description: "Marea Residences by Sharafi | Luxury Beachfront Homes on Dubai Islands",
};
