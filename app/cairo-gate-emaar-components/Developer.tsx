    ...
    <section id="about" className="py-24 px-6 bg-[#F8FAFC] text-slate-900 overflow-hidden">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <blockquote className="border-l-4 border-emerald-100 pl-6 py-2">
               ...
               Cairo Gate’s masterplan is designed around exclusivity, connectivity, and elevated living. Set in a premium Sheikh Zayed location, it brings together world-class hospitality, signature residences, vibrant social and commercial destinations, and lush open spaces within a secure, gated community.
              </p>
            </blockquote>
          </div>
        </motion.div>
        ...
        <div className="relative h-[600px] flex items-center justify-center">
          ...
          >
            <img 
              src="https://www.emaarmisr.com/wp-content/uploads/2025/10/Emaar-Misr-Cairo-Gate-Elan-Hero.jpg" 
          ...
          >
            <img 
              src="https://www.emaarmisr.com/wp-content/uploads/2025/10/Emaar-Misr-Cairo-Gate-Aspen-Villas-1.jpg" 
