...
const Gallery = () => {
  const images = [
    "https://caramondani.com/wp-content/uploads/2022/11/ANM-January-2022-DJI_0402-HDR.jpg",
    "https://caramondani.com/wp-content/uploads/2022/09/anm_final_view-3_aerial_updated_web_rgb-1-1920x914-1.jpg",
    "https://caramondani.com/wp-content/uploads/2022/09/anm-may-2022-34-scaled-1.jpg",
    "https://caramondani.com/wp-content/uploads/2022/10/ANM-July-2022-0285-scaled.jpg",
    "https://caramondani.com/wp-content/uploads/2022/10/IMG_4683-scaled.jpg",
    "https://caramondani.com/wp-content/uploads/2022/10/June-2022-IMG_9349-scaled.jpg",
    "https://caramondani.com/wp-content/uploads/2022/10/ANM-December-2021-20211126_094746-scaled.jpg",
    "https://caramondani.com/wp-content/uploads/2022/10/IMG_4683-scaled.jpg",
    "https://caramondani.com/wp-content/uploads/2022/10/ANM-January-2022-DJI_0280-HDR.jpg",
    "https://caramondani.com/wp-content/uploads/2022/10/IMG_8619-scaled.jpg",
  ];

  const [active, setActive] = useState(0);

  return (
    <section className="bg-black py-20 md:py-28 px-5 md:px-10 text-white">
      <div className="max-w-7xl mx-auto space-y-12">

        {/* HEADER */}
        <div className="text-center">
          <p className="text-[#38bdf8] text-[10px] tracking-[0.7em] uppercase mb-4">
            Gallery
          </p>
          <h2 className="text-4xl md:text-6xl font-light">
            Visual{" "}
            <span className="italic text-[#38bdf8] font-serif">
              Experience
            </span>
          </h2>
        </div>
        ...
        <motion.div
          ...
          className="relative h-[350px] sm:h-[450px] md:h-[600px] rounded-[30px] overflow-hidden"
        >
          <img
            src={images[active]}
          ...
          {/* COUNT */}
          <div className="absolute bottom-6 left-6 text-white/70 text-sm tracking-widest">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
          ...
          {images.map((img, i) => (
            <div
              key={i}
              onClick={() => setActive(i)}
              className={`relative min-w-[120px] sm:min-w-[140px] h-24 sm:h-28 rounded-xl overflow-hidden cursor-pointer group ${
                active === i ? "ring-2 ring-[#38bdf8]" : ""
              }`}
            >
              <img
                src={img}
      ...
      {/* BACKGROUND GLOW */}
      <div className="absolute right-0 top-0 w-1/3 h-full bg-[#38bdf8]/10 blur-3xl pointer-events-none" />
    </section>
  );
};
