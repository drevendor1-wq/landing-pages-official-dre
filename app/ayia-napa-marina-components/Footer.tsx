...
const Footer: React.FC = () => {
  ...
  useEffect(() => {
    if (!footerRef.current || !contentRef.current || !imageColRef.current) return;

    const ctx = gsap.context(() => {
      // Animate content (the children of contentRef)
        ...
        <div className="damac_footer_row">
          ...
          <div className="damac_footer_image_col" ref={imageColRef}>
            <div className="damac_footer_image_wrapper">
              <Image
                src="/images/nakheel-palm-central/AYIA-NAPA-MARINA-FOOTER.png"
                alt="Modern Interior"
                width={1200}
                height={700}
