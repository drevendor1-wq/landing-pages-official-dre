...
const galleryImages: GalleryImage[] = [
  { src: "/images/damac-islands/DamacIslandsGallery1.jpeg", alt: "Gallery Image 1" },
  { src: "/images/damac-islands/DamacIslandsGallery2.jpg", alt: "Gallery Image 2" },
  { src: "/images/damac-islands/DamacIslandsGallery3.jpg", alt: "Gallery Image 3" },
  { src: "/images/damac-islands/DamacIslandsGallery4.webp", alt: "Gallery Image 4" },
  { src: "/images/damac-islands/DamacIslandsGallery5.webp", alt: "Gallery Image 5" },
  { src: "/images/damac-islands/DamacIslandsGallery6.jpg", alt: "Gallery Image 6" },
];
      ...
      <section id="gallery" className="damac_gallery_section" ref={galleryRef}>
        <div className="container">
          <div className="damac_gallery_header" ref={headerRef}>
            ...
            <p className="damac_gallery_tagline">Inspired by a legacy of innovation. Discover an architectural collection that breathes the sophistication and timelessness of Damac Islands.</p>
          </div>
