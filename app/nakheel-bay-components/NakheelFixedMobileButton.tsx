...
const NakheelFixedMobileButton = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 md:hidden p-1 bg-emerald-700/80 backdrop-blur-lg border-t border-emerald-100 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
        <button
          onClick={togglePopup}
            ...
            >
              <div className="relative w-full bg-white rounded-t-[2.5rem] shadow-2xl p-8 pb-12 overflow-hidden border-t border-emerald-50">
                ...
                <div className="mt-4 mb-8">
                  <span className="text-emerald-700 font-bold tracking-[0.3em] uppercase text-[10px] mb-2 block">
                    Exclusive Access
                  </span>
                  <h2 className="text-3xl font-serif text-black tracking-tighter leading-none">
                    Get Costing Details<br /><span className="text-emerald-900/70 font-light text-[19px]">Bay Villas by Nakheel</span>
                  </h2>
                </div>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full mt-4 bg-black text-white py-5 rounded-xl font-bold text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-emerald-900 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-3"
                  >
