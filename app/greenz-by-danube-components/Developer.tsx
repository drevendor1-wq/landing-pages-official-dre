      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg text-slate-600 leading-relaxed mb-10 font-light">
            Danube Properties is one of the UAE’s leading real estate developers known for delivering affordable luxury homes with innovative payment plans. With a strong portfolio of successful residential projects across Dubai, the company is recognized for quality construction, timely delivery, and customer-centric developments.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative aspect-[4/5] md:aspect-square rounded-sm overflow-hidden shadow-2xl shadow-blue-900/10">
            <img 
              src="https://cms.propjunction.com/Project/Project_Index/3227/Thumb/3227.webp" 
              alt="Developer HQ" 
