...
const FloorPlan = () => {
  const [activePlan, setActivePlan] = useState('3 Bedroom Townhouses');
  ...
  const plans = {
    '3 Bedroom Townhouses': { 
      price: '4.2M', 
      description: 'Spacious 3-bedroom townhouse designed for modern families seeking comfort and privacy. Features open living spaces, contemporary architecture, and private garden.',
    ...
    '4 Bedroom Townhouses': { 
      price: '6.8M', 
      description: 'Elegant 4-bedroom townhouse crafted for growing families who value generous living spaces. Expansive layouts, premium finishes, and landscaped surroundings.',
    ...
    '5 Bedroom Townhouses': { 
      price: '8.5M', 
      description: 'Luxury 5-bedroom townhouse offering large layouts designed for families seeking space, privacy, and upscale living. Modern design with premium interiors.',
